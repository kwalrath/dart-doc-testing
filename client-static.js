...
$.json = function() {
  return [$.makeLiteralMap(["name", "comment_test", "members", [$.makeLiteralMap(["kind", "method", "noparams", true, "name", "main"])], "types", [$.makeLiteralMap(["name", "CommentTester", "kind", "class", "members", [$.makeLiteralMap(["kind", "getter", "noparams", true, "name", "a"]), $.makeLiteralMap(["kind", "setter", "name", "a", "link_name", "a="]), $.makeLiteralMap(["kind", "field", "name", "aNumber"]), $.makeLiteralMap(["kind", "getter", "noparams", true, "name", "b"]), $.makeLiteralMap(["kind", "setter", "name", "b", "link_name", "b="]), $.makeLiteralMap(["kind", "constructor", "noparams", true, "name", "CommentTester"]), $.makeLiteralMap(["kind", "constructor", "name", "CommentTester.withNumber"]), $.makeLiteralMap(["kind", "method", "noparams", true, "name", "doSomething"])]]), $.makeLiteralMap(["name", "SubTester", "kind", "class", "members", [$.makeLiteralMap(["kind", "constructor", "noparams", true, "name", "SubTester"])]])]])];
};
